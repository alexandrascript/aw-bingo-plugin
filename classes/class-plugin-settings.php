...
class AW_Bingo_Settings_Page { 
  ...
  public function register_settings() {
    ...
    add_settings_field( 'winner2_card1', 'Winner image for Card 1', array( $this, 'settings_field'), 'aw_bingo_settings', 'bingosetup', array('setting' => 'aw_bingo_settings', 'field' => 'winner2_card1', 'class' => 'large-text', 'label' => 'Enter the image url for your winner card') );
    add_settings_field( 'winner3_card1', 'Winner image for Card 1', array( $this, 'settings_field'), 'aw_bingo_settings', 'bingosetup', array('setting' => 'aw_bingo_settings', 'field' => 'winner3_card1', 'class' => 'large-text', 'label' => 'Enter the image url for your winner card') );
    ...
    add_settings_field( 'winner2_card2', 'Winner image for Card 2', array( $this, 'settings_field'), 'aw_bingo_settings', 'bingosetup', array('setting' => 'aw_bingo_settings', 'field' => 'winner2_card2', 'class' => 'large-text', 'label' => 'Enter the image url for your winner card') );
    add_settings_field( 'winner3_card2', 'Winner image for Card 2', array( $this, 'settings_field'), 'aw_bingo_settings', 'bingosetup', array('setting' => 'aw_bingo_settings', 'field' => 'winner3_card2', 'class' => 'large-text', 'label' => 'Enter the image url for your winner card') );
    ...
    add_settings_field( 'winner2_card3', 'Winner image for Card 3', array( $this, 'settings_field'), 'aw_bingo_settings', 'bingosetup', array('setting' => 'aw_bingo_settings', 'field' => 'winner2_card3', 'class' => 'large-text', 'label' => 'Enter the image url for your winner card') );
    add_settings_field( 'winner3_card3', 'Winner image for Card 3', array( $this, 'settings_field'), 'aw_bingo_settings', 'bingosetup', array('setting' => 'aw_bingo_settings', 'field' => 'winner3_card3', 'class' => 'large-text', 'label' => 'Enter the image url for your winner card') );
  ...
  public function howto() { echo '<p>To use the plugin, attach 25 images for the cards to your post.<br />Insert two shortcodes into your post body content:<br />[bingocard]<br />[bingo_gallery]</p>'; }
